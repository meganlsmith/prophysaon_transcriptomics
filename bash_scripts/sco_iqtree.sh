...
# Change path to IQ-Tree to the path of your installation.

programs/iqtree-2.0.6-Linux/bin/iqtree2 -s ./sco_ys_alignments/concatenated.nex -m MFP -B 1000 --prefix ./iqtree_ys/sco
